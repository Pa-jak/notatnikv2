...
// Sprawdź czy baza już zaseedowana.
...
// --- DANE SEEDOWE (1:1 z lib/mock.ts) ---
...
try {
    ...
    echo "W tym note_mentions wstawione: $noteMentionCount, project_people: $projectPeopleCount\n";
} catch (Throwable $e) {
